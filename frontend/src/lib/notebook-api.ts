...
export const notebookApi = {
  ...
  submitQuery: (notebookId: string, query: string, clientMessageId: string) => apiFetch<{ message: string; jobId: string }>("/query", { method: "POST", data: { query, notebookId, clientMessageId } }),
